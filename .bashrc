...
alias ni_mdx="npm install @next/mdx @mdx-js/loader @mdx-js/react @types/mdx next-mdx-remote ; echo \"THEN, create mdx-components.tsx file at the root; And configure next.config.js file for tailoring mdx in nextjs ; Finally, you can add support for remote mdx files by using either next-mdx-remote either contentlayer(not tryed yet... ni contentlayer next-contentlayer date-fns)\" "
alias ni_prisma="npm install prisma @prisma/client --save-dev ; echo \"THEN, set up Prisma with the init command of the Prisma CLI: npx prisma init --datasource-provider sqlite\r\nTHEN, Model your data in the prisma.schema file, \r\nTHEN, Run a migration with:  npx prisma migrate dev --name init\""
alias ni_apollo_server="npm install @apollo/server graphql ; echo\"THEN, create the server apollo file (ex: lib/apollo/index.js) and the required datas, typeDefs and resolvers, in a separate file (ex: lib/apollo/schema.js)\" "
alias ni_graph_apollo_server="ni_apollo_server "
# ------------------------------------------------------------------
# ---------------CODEBASE CREATION----------------------------------
...
# ------------------------------------------------------------------
### GIT MANIPULATIONS
alias g_webdev="git config --global user.name 'webdev-archist' ; git config --global user.email 'webdev.archist@gmail.com' --replace-all "
alias g_archist="git config --global user.name 'achicyr' ; git config --global user.email 'hi.cyril@gmail.com' --replace-all "
alias g_yasushi="git config --global user.name '康さん' ; git config --global user.email 'yasushi.jlpt@gmail.com' --replace-all "
alias g_mentor="git config --global user.name 'archist' ; git config --global user.email 'mentor03.archist@gmail.com' --replace-all "
alias g_athena="git config --global user.name 'athena' ; git config --global user.email 'legion.athenienne@gmail.com' --replace-all "
...
alias g_ssh_athena="cp ~/ssh/athena/id_rsa ~/.ssh/id_rsa ; cp ~/ssh/athena/id_rsa.pub ~/.ssh/id_rsa.pub "
...
alias gathena="g_athena ; g_ssh_athena "
### GIT BASE CONFIGS
